        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
            ...
            <div className="flex items-start justify-between mb-4">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-black">ATS-Optimized Resume</h3>
                        <p className="text-sm text-gray-600 mt-1">
                            AI-rebuilt resume with all suggestions applied. Ready to copy and paste!
                        </p>
                    </div>
                </div>
            </div>
            ...
            {!optimizedResume ? (
                <div className="text-center py-8">
                    ...
                    <p className="text-gray-600 mb-6 max-w-md mx-auto">
                        ...
                        formatted for maximum ATS compatibility.
                    </p>
                    <button
                ...
                <div className="flex items-start gap-2">
                    ...
                    <div className="text-sm text-blue-800">
                        ...
                        <ul className="list-disc list-inside space-y-1 text-blue-700">
                            <li>All improvement suggestions applied</li>
                            <li>ATS-optimized formatting and keywords</li>
                            <li>Quantified achievements where possible</li>
                            <li>Clean, parseable structure</li>
                            <li>Ready to paste into any application</li>
                        </ul>
                    </div>
                </div>
            </div>
